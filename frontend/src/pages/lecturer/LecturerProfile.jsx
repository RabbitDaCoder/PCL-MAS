// Lecturer profile — view + edit name/department/institution; email is read-only; password
...
import { updateLecturerProfile } from "../../services/lecturerService";
...
export default function LecturerProfile() {
  ...
  async function handleSave(event) {
    ...
    setIsSaving(true);
    try {
      const updated = await updateLecturerProfile(values);
      updateUser(updated);
